...
namespace PcrNew
{
    public partial class FMain : UIHeaderAsideMainFrame
    {
        public FMain()
        {
            ...
            Aside.CreateChildNode(parent, AddPage(CreateInstance<UIPage>("PcrNew.FPipe")));
            Aside.CreateChildNode(parent, AddPage(CreateInstance<UIPage>("PcrNew.FMeter")));
            Aside.CreateChildNode(parent, AddPage(CreateInstance<UIPage>("PcrNew.FLed")));
            Aside.CreateChildNode(parent, AddPage(CreateInstance<UIPage>("PcrNew.FLight")));
