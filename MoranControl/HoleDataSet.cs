...
namespace PcrNew.MoranControl
{
    ...
    public class HoleData
    {
        ...
        public override string ToString()
        {
            ...
            //return "检测项目:" + ItemName + " 属性:" + ItemAttribute;//ThisHoleType +GroupName +

            if (ThisHoleType == HoleType.Null)
            {
                return "";
            }
            else if (ItemViscosity is null)
            {
                return "检测项目:" + ItemName + " 属性:" + ItemAttribute;//ThisHoleType +GroupName +
            }
            else
            {
                return "检测项目:" + ItemName + " 属性:" + ItemAttribute + " 浓度：" + ItemViscosity;
            }
        }

        public string ItemViscosity { get; set; }
