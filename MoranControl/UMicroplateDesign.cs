...
using CRYSTAL;
using PcrNew.MoranControl.runMicroplate;
...
namespace PcrNew.MoranControl
{
    public partial class UMicroplateDesign : UserControl
    {
        ...
        {
            StripClearItem.Text = MoranControl.MoranLanguage.UMicroplateDesign_ClearItem;
            StripClearSample.Text = MoranControl.MoranLanguage.UMicroplateDesign_ClearSample;
            StripClearItemAndSample.Text = MoranControl.MoranLanguage.UMicroplateDesign_ClearItemSample;
        }
        ...
        private void StripClearItem_Click(object sender, EventArgs e)
        {
            foreach (DataGridViewCell cell in dgPlate.SelectedCells)
            {
                HoleData hd = (HoleData)cell.Value;
        ...
        private void StripClearSample_Click(object sender, EventArgs e)
        {
            foreach (DataGridViewCell cell in dgPlate.SelectedCells)
            {
                HoleData hd = (HoleData)cell.Value;
        ...
        private void StripClearItemAndSample_Click(object sender, EventArgs e)
        {
            foreach (DataGridViewCell cell in dgPlate.SelectedCells)
            {
                HoleData hd = (HoleData)cell.Value;
