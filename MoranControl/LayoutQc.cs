...
{
    public partial class LayoutQc : UserControl
    {
        public LayoutQc()
        {
            InitializeComponent();
        }
        private Color _containerColor = Color.Transparent;//容器填充颜色
        ...
        private void LayoutQc_Load(object sender, EventArgs e)
        {
            foreach (Control control in this.Controls)
            {
                if (control is MyButtonX)
        ...
        //{
        //    SkinButton skinButton = sender as SkinButton;
        //    toolTip1.Dispose();
        //    toolTip1 = new ToolTip();
        //    toolTip1.SetToolTip(skinButton, skinButton.Tag.ToString());
        //}
    }
}
